/**
 * So, the e2e-client-wasm package has the raw wasm module in it, but in order to
...
import { Message, MessageListResponse } from "e2e-client-wasm";

export class MessagesAPI {
  // URI prefix for the backend server
  private readonly prefix: string;
  // this is the wasm module...
  private readonly rust: Promise<any>;

  constructor(prefix: string, rust: Promise<any>) {
    this.prefix = prefix;
    this.rust = rust;
  }
