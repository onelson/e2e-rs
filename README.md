...
Other than these tweaks, the tutorial proved accurate. We use a macro in our
`schema` module which includes code generated by the build script, based on the 
`.proto` file.
